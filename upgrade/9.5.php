...
if( $_SESSION['step_update'] == 5 ) {
	...
	msgbox("info","Информация", "<form action=\"index.php\" method=\"GET\">Обновление базы данных с версии <b>9.5</b> до версии <b>9.6</b> успешно завершено.<br /><br />Нажмите далее для продолжения процессa обновления скрипта<br /><br /><input type=\"hidden\" name=\"next\" value=\"96\"><input class=\"edit\" type=\"submit\" value=\"Далее ...\"></form>");

...
<div class="panel">
    <div class="news">Полное имя: {fullname}
                              ...
                              <br />Номер ICQ: {icq}
                              <br />Немного о себе:<br />{info}<br /><br />Количество публикаций:     {news-num}<br />[ {news} ] [rss]<img src="{THEME}/css/rss_icon.gif" border="0" />[/rss]
                              <br /><br />Количество комментариев: {comm-num}<br />[ {comments} ]<br /><br />[ {email} ]<br />[ {pm} ]<br />{edituser}</div>
</div>
